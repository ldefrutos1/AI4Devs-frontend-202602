...
Parece que el codigo actual usa fecth y services; vamos a quedarnos con una única forma de invocar al back; dime cual crees más conveniente
...
ok, Puedes cambiar SOLO el que en lugar de un mock se cargue la información del nuevo endpoint 
